...
export const FormRegisterResident = () => {
  ...
  return (
    ...
    >
      <div>
        <FormInput.Root className={errors.name && 'border-danger border-2'}>
          <FormInput.Label
            htmlFor="name"
      ...
      <div>
        <FormInput.Root className={errors.cpf && 'border-danger border-2'}>
          <FormInput.Label
            htmlFor="cpf"
      ...
      <div>
        <FormInput.Root className={errors.email && 'border-danger border-2'}>
          <FormInput.Label
            htmlFor="email"
      ...
      <div>
        <FormInput.Root className={errors.password && 'border-danger border-2'}>
          <FormInput.Label
            htmlFor="password"
          ...
          <div className="flex w-full items-center gap-2">
            ...
            >
              ...
              <span className="sr-only">Mostrar/esconder senha</span>
            </button>
          </div>
        </FormInput.Root>
      ...
      <div>
        <FormInput.Root
          className={errors.checkPassword && 'border-danger border-2'}
        >
          <FormInput.Label
          ...
          <div className="flex w-full items-center gap-2">
            <FormInput.Input
              ...
              className={cn(
                'w-full',
                errors.checkPassword && 'placeholder:text-danger'
              )}
            />
            <button
              type="button"
        ...
        {errors.checkPassword?.message && (
          <FormInput.ErrorMessage error={errors.checkPassword.message} />
        )}
      </div>
      <Dialog.Root>
        <Dialog.Trigger>
